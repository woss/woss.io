...
type LoggerConfig<T extends LoggerType> = T extends 'file' ? { type: T; filename: string } : { type: T };
...
type Event = { type: 'FETCH' } | { type: 'SUCCESS'; data: any } | { type: 'ERROR'; error: Error } | { type: 'RETRY' };
